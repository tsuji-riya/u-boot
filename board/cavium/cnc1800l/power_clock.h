#ifndef __POWER_CLOCK_H__
#define __POWER_CLOCK_H__
...
int ClockUSB1PhyBypassEnable(void);
int ClockUSB1PhyBypassDisable(void);
...
int ClockUSBReset(CLOCK_RESET ResetOrSet);
